...
EXTERN_C const IID IID_Ihello;
    ...
    MIDL_INTERFACE("ff88c870-69d0-46af-9576-8a9bc04c48a2")
    Ihello : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE hahaha( 
            /* [out] */ LONG *a) = 0;
    ...
    typedef struct IhelloVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *hahaha )( 
            Ihello * This,
            /* [out] */ LONG *a);
...
#define Ihello_hahaha(This,a)	\
    ( (This)->lpVtbl -> hahaha(This,a) ) 
...
class DECLSPEC_UUID("cffc0341-3515-4bff-9ccb-7c39c784b429")
CompReg;
#endif
...
class DECLSPEC_UUID("5a64f1c2-97a3-47f0-8d10-5b27472532cf")
hello;
#endif
